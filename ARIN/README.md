...
This project provides OpenAPI specs for building automation against both services via an Integration Model — see **OpenAPIs** below. Both are public and require no authentication.

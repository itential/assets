...
| [`tufin_securetrack-25.2.json`](./OpenAPIs/tufin_securetrack-25.2.json) | 25.2 | 275 | Full spec for SecureTrack R25-2 (275 operations, Swagger 1.2, as published by the vendor) |

...
**Branch:** `feature/gw5-upgrade/main-pr`
**Status:** Complete
**Files modified:** `Cisco/ASA/Studio Projects/Cisco ASA.project.json`
...
`Cisco/IOS/Studio Projects/Cisco IOS.project.json` — same vendor, same CLI pattern. The IOS project's Port Turn Up and IOS Upgrade workflows are the direct reference for the `sendConfig` task shape.

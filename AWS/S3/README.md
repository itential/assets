...
Full spec for the Amazon S3 API (2006-03-01) (99 operations) — the entire upstream API surface as AWS defines it. See `amazon_s3-latest.json` above for the curated subset if you just need common CRUD automation.

...
### `amazon_connect-latest.json` (curated)
...
| Spec | Description |
|---|---|
| [`amazon_connect-2017-08-08.json`](./OpenAPIs/amazon_connect-2017-08-08.json) | Full spec for Amazon Connect API version 2017-08-08 (171 operations). |

...
- [OpenAPIs](#openapis)
  - [`cisco_ise_5g-latest.json`](#cisco_ise_5g-latestjson)
  - [`cisco_ise_5g-1.0.0.json`](#cisco_ise_5g-100json)
  - [`cisco_ise_backup_and_restore-latest.json`](#cisco_ise_backup_and_restore-latestjson)
  - [`cisco_ise_backup_and_restore-1.0.0.json`](#cisco_ise_backup_and_restore-100json)
  - [`cisco_ise_certificates-latest.json`](#cisco_ise_certificates-latestjson)
  - [`cisco_ise_certificates-1.0.0.json`](#cisco_ise_certificates-100json)
  - [`cisco_ise_custom_attributes-latest.json`](#cisco_ise_custom_attributes-latestjson)
  - [`cisco_ise_custom_attributes-1.0.0.json`](#cisco_ise_custom_attributes-100json)
  - [`cisco_ise_data_connect-latest.json`](#cisco_ise_data_connect-latestjson)
  - [`cisco_ise_data_connect-1.0.0.json`](#cisco_ise_data_connect-100json)
  - [`cisco_ise_deployment-latest.json`](#cisco_ise_deployment-latestjson)
  - [`cisco_ise_deployment-1.0.0.json`](#cisco_ise_deployment-100json)
  - [`cisco_ise_duo_identity_sync-latest.json`](#cisco_ise_duo_identity_sync-latestjson)
  - [`cisco_ise_duo_identity_sync-1.0.0.json`](#cisco_ise_duo_identity_sync-100json)
  - [`cisco_ise_endpoint_replication-latest.json`](#cisco_ise_endpoint_replication-latestjson)
  - [`cisco_ise_endpoint_replication-1.0.0.json`](#cisco_ise_endpoint_replication-100json)
  - [`cisco_ise_endpoints-latest.json`](#cisco_ise_endpoints-latestjson)
  - [`cisco_ise_endpoints-1.0.0.json`](#cisco_ise_endpoints-100json)
  - [`cisco_ise_ipsec-latest.json`](#cisco_ise_ipsec-latestjson)
  - [`cisco_ise_ipsec-1.0.0.json`](#cisco_ise_ipsec-100json)
  - [`cisco_ise_licensing-latest.json`](#cisco_ise_licensing-latestjson)
  - [`cisco_ise_licensing-1.0.0.json`](#cisco_ise_licensing-100json)
  - [`cisco_ise_lsd_settings-latest.json`](#cisco_ise_lsd_settings-latestjson)
  - [`cisco_ise_lsd_settings-1.0.0.json`](#cisco_ise_lsd_settings-100json)
  - [`cisco_ise_mfa-latest.json`](#cisco_ise_mfa-latestjson)
  - [`cisco_ise_mfa-1.0.0.json`](#cisco_ise_mfa-100json)
  - [`cisco_ise_network_device_groups-latest.json`](#cisco_ise_network_device_groups-latestjson)
  - [`cisco_ise_network_device_groups-1.0.0.json`](#cisco_ise_network_device_groups-100json)
  - [`cisco_ise_network_devices-latest.json`](#cisco_ise_network_devices-latestjson)
  - [`cisco_ise_network_devices-1.0.0.json`](#cisco_ise_network_devices-100json)
  - [`cisco_ise_nodes-latest.json`](#cisco_ise_nodes-latestjson)
  - [`cisco_ise_nodes-1.0.0.json`](#cisco_ise_nodes-100json)
  - [`cisco_ise_patches-latest.json`](#cisco_ise_patches-latestjson)
  - [`cisco_ise_patches-1.0.0.json`](#cisco_ise_patches-100json)
  - [`cisco_ise_policy-latest.json`](#cisco_ise_policy-latestjson)
  - [`cisco_ise_policy-1.0.0.json`](#cisco_ise_policy-100json)
  - [`cisco_ise_pxgrid_direct-latest.json`](#cisco_ise_pxgrid_direct-latestjson)
  - [`cisco_ise_pxgrid_direct-1.0.0.json`](#cisco_ise_pxgrid_direct-100json)
  - [`cisco_ise_repository-latest.json`](#cisco_ise_repository-latestjson)
  - [`cisco_ise_repository-1.0.0.json`](#cisco_ise_repository-100json)
  - [`cisco_ise_sgt_reservation-latest.json`](#cisco_ise_sgt_reservation-latestjson)
  - [`cisco_ise_sgt_reservation-1.0.0.json`](#cisco_ise_sgt_reservation-100json)
  - [`cisco_ise_system_settings-latest.json`](#cisco_ise_system_settings-latestjson)
  - [`cisco_ise_system_settings-1.0.0.json`](#cisco_ise_system_settings-100json)
  - [`cisco_ise_task_service-latest.json`](#cisco_ise_task_service-latestjson)
  - [`cisco_ise_task_service-1.0.0.json`](#cisco_ise_task_service-100json)
  - [`cisco_ise_trustsec-latest.json`](#cisco_ise_trustsec-latestjson)
...
### `cisco_ise_5g-1.0.0.json`

Full, unmodified vendor spec for the 5G module, API version 1.0.0 (16 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_5g-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_backup_and_restore-1.0.0.json`

Full, unmodified vendor spec for the Backup and Restore module, API version 1.0.0 (6 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_backup_and_restore-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_certificates-1.0.0.json`

Full, unmodified vendor spec for the Certificates module, API version 1.0.0 (22 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_certificates-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_custom_attributes-1.0.0.json`

Full, unmodified vendor spec for the Custom Attributes module, API version 1.0.0 (5 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_custom_attributes-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_data_connect-1.0.0.json`

Full, unmodified vendor spec for the Data Connect module, API version 1.0.0 (5 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_data_connect-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_deployment-1.0.0.json`

Full, unmodified vendor spec for the Deployment module, API version 1.0.0 (24 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_deployment-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_duo_identity_sync-1.0.0.json`

Full, unmodified vendor spec for the Duo Identity Sync module, API version 1.0.0 (8 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_duo_identity_sync-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_endpoint_replication-1.0.0.json`

Full, unmodified vendor spec for the Endpoint Replication module, API version 1.0.0 (2 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_endpoint_replication-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_endpoints-1.0.0.json`

Full, unmodified vendor spec for the Endpoints module, API version 1.0.0 (10 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_endpoints-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_ipsec-1.0.0.json`

Full, unmodified vendor spec for the IPsec module, API version 1.0.0 (9 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_ipsec-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_licensing-1.0.0.json`

Full, unmodified vendor spec for the Licensing module, API version 1.0.0 (9 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_licensing-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_lsd_settings-1.0.0.json`

Full, unmodified vendor spec for the LSD Settings module, API version 1.0.0 (2 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_lsd_settings-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_mfa-1.0.0.json`

Full, unmodified vendor spec for the MFA module, API version 1.0.0 (6 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_mfa-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_network_device_groups-1.0.0.json`

Full, unmodified vendor spec for the Network Device Groups module, API version 1.0.0 (8 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_network_device_groups-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_network_devices-1.0.0.json`

Full, unmodified vendor spec for the Network Devices module, API version 1.0.0 (13 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_network_devices-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_nodes-1.0.0.json`

Full, unmodified vendor spec for the Nodes module, API version 1.0.0 (4 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_nodes-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_patches-1.0.0.json`

Full, unmodified vendor spec for the Patches module, API version 1.0.0 (6 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_patches-latest.json` above for the curated subset if you just need common CRUD automation.

### `cisco_ise_policy-latest.json`
...
### `cisco_ise_policy-1.0.0.json`

Full, unmodified vendor spec for the Policy module, API version 1.0.0 (126 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_policy-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_pxgrid_direct-1.0.0.json`

Full, unmodified vendor spec for the pxGrid Direct module, API version 1.0.0 (7 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_pxgrid_direct-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_repository-1.0.0.json`

Full, unmodified vendor spec for the Repository module, API version 1.0.0 (6 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_repository-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_sgt_reservation-1.0.0.json`

Full, unmodified vendor spec for the SGT Reservation module, API version 1.0.0 (5 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_sgt_reservation-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_system_settings-1.0.0.json`

Full, unmodified vendor spec for the System Settings module, API version 1.0.0 (4 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_system_settings-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_task_service-1.0.0.json`

Full, unmodified vendor spec for the Task Service module, API version 1.0.0 (2 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_task_service-latest.json` above for the curated subset if you just need common CRUD automation.
...
### `cisco_ise_trustsec-1.0.0.json`

Full, unmodified vendor spec for the TrustSec module, API version 1.0.0 (13 operations) — the vendor's complete API surface, preserved as-is. See `cisco_ise_trustsec-latest.json` above for the curated subset if you just need common CRUD automation.

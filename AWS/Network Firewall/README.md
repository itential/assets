...
| [`aws_network_firewall-2020-11-12.json`](./OpenAPIs/aws_network_firewall-2020-11-12.json) | 2020-11-12 | 36 | Full spec |
...
Full spec for API version 2020-11-12 (36 operations) — the entire upstream API surface as AWS defines it. Both specs cover the same operation set.

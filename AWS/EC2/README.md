...
Full spec for EC2 API version 2016-11-15 (627 actions, 1,254 GET/POST operations) — covering the entire upstream API surface as AWS defines it. See `amazon_ec2-latest.json` above for the curated subset if you just need common CRUD automation.

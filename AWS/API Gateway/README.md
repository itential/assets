...
Full spec for the Amazon API Gateway `2015-07-09` management API (120 operations) — the entire upstream API surface as AWS defines it. See `amazon_api_gateway-latest.json` above for the curated subset if you just need common CRUD automation.
